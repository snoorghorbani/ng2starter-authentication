...
import { UserModel, Signin_ApiModel, CheckSignInFromLocalStorageAction_PayloadModel, SignInSucceedAction_PayloadModel } from '../models';
...
export class SigninSecceed implements Action {
        ...
        constructor(public payload: SignInSucceedAction_PayloadModel) { }
}
