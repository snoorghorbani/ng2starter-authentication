...
var RootAuthenticationModule = /** @class */ (function () {
    function RootAuthenticationModule() {
    }
    RootAuthenticationModule.decorators = [
        { type: core_1.NgModule, args: [{
                    imports: [
    ...
    /** @nocollapse */
    RootAuthenticationModule.ctorParameters = function () { return []; };
    return RootAuthenticationModule;
}());
