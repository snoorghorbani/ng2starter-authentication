...
var SigninService = /** @class */ (function () {
    function SigninService(http, configurationService, snackBar) {
        ...
        this.SigninResponse = new BehaviorSubject_1.BehaviorSubject(undefined);
    }
    SigninService.prototype.signin = function (data) {
        ...
        return this.configurationService.config$
            ...
            return _this.http.post(_this.configurationService.config.endpoints.signIn, model.getRequestBody());
        })
    ...
    SigninService.prototype.is_role = function (role) {
        return this.SigninResponse.map(function (user) { return user.Roles.indexOf(role) > -1; });
    };
